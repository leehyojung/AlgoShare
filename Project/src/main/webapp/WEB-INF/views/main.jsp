	...
	<div class="header">
		<div class="wrap">
			...
			<div class="userinfo">
				<div class="user">
					<ul>
						<li><a href="#"><span><button>로그인</span>
								</button></a></li>
					</ul>
					<p>
		...
		<div class="wrap">
			<div id="main" role="main">
				<ul id="tiles">
					...
					<li onclick="location.href='form';"><img
						src="resources/common/hyo/images/C.jpg" width="282" height="118">
						<div class="post-info">
							<div class="post-basic-info">
								<h3>
									<a href="#">C언어 사용 알고리즘 스터디</a>
								</h3>
								<span><a href="#"><label> </label>Algorithm</a></span>
								<p>오직 c언어만을 사용하는 스터디입니다.</p>
							</div>
						</div>
					</li>
					<li onclick="location.href='single-page.html';"><img
						src="resources/common/hyo/images/tmon.png" width="282"
						height="118">
						<div class="post-info">
							<div class="post-basic-info">
								<h3>
									<a href="#">티몬 2차테스트 준비 스터디</a>
								</h3>
								<span><a href="#"><label> </label>Algorithm</a></span>
								<p>같이 준비해요~</p>
							</div>
					...
					<li onclick="location.href='single-page.html';"><img
						src="resources/common/hyo/images/alg.png" width="282" height="118">
						<div class="post-info">
							<div class="post-basic-info">
								<h3>
									<a href="#">알고리즘 공부 스터디</a>
								</h3>
								<span><a href="#"><label> </label>Algorithm</a></span>
								<p>기초부터 차근차근 시도하는 스터디!</p>
							</div>
						</div></li>
					<li onclick="location.href='single-page.html';"><img
						src="resources/common/hyo/images/samsung.jpg" width="282"
						height="118">
						<div class="post-info">
							<div class="post-basic-info">
								<h3>
									<a href="#">삼성 소프트웨어 역량 테스트 준비 스터디</a>
								</h3>
								<span><a href="#"><label> </label>Algorithm</a></span>
								<p>5/17 역량테스트 준비하는 스터디입니다.</p>
							</div>
						</div></li>
					<!--<li onclick="location.href='single-page.html';">
			        	<img src="resources/common/hyo/images/img2.jpg" width="282" height="344">
						<div class="post-info">
			        		<div class="post-basic-info">
